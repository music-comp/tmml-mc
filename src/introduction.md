...
1. **Orientation** to the structure of Messiaen's original text
2. **Modern scholarly summaries** of each chapter, using contemporary music-theoretical terminology
3. **Reference tools** for quick lookup during composition or analysis
...
*Use the search function (🔍) or the sidebar to navigate.*

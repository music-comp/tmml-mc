...
**1. Elimination:** Progressive reduction toward essential core  
Take an eight-note theme → reduce to four notes → reduce to two notes → reduce to one

**2. Interversion:** Reordering pitch content while preserving pitch-class collection  
The notes stay the same, but their sequence changes—same ingredients, different recipe

**3. Registral change:** Extreme octave displacement creating textural transformation  
Low becomes high, high becomes low, wide leaps create new character
